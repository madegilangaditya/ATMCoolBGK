								...
								<?php
									...
									while($baris = mysql_fetch_array($query)){
										echo "<tr>
												...
												<td>
													<a href='admin.php?page=edit-admin&id=$baris[username]'><i class='fa fa-pencil fa-lg'></i></a>
													<a href='proses-delete-admin.php?id=$baris[username]' onclick='return delete(\"Apa anda yakin untuk menghapus".$baris["username"]."?\")'><i class='fa fa-trash fa-lg'></i></a>
												</td>			
												</tr>";
									$i++;
									}
